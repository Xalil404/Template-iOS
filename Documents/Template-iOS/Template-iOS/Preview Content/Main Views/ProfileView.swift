...
struct ProfileView: View {
    ...
    private func fetchUserProfile() {
        guard let token = UserDefaults.standard.string(forKey: "authToken"),
              let url = URL(string: "https://backend-django-9c363a145383.herokuapp.com/api/profile/") else { return }
...
struct EditProfileView: View {
    ...
    private func saveChanges() {
        guard let token = UserDefaults.standard.string(forKey: "authToken"),
              let url = URL(string: "https://backend-django-9c363a145383.herokuapp.com/api/profile_update/") else { return }
